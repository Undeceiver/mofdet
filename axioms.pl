...
axiom(forall(v1,equal(v1,v1)),dummy_axiom).
...
lemma(lnot(exists(v1,and(edamozzarella_topping(v1),exists(v2,has_topping(v1,v2))))),
	[and(forall(v1,implies(exists(v2,and(edam_topping(v2),has_topping(v1,v2))),lnot(exists(v2,and(mozzarella_topping(v2),has_topping(v1,v2)))))),
		forall(v1,implies(exists(v2,and(mozzarella_topping(v2),has_topping(v1,v2))),lnot(exists(v2,and(edam_topping(v2),has_topping(v1,v2)))))))],
	edamozzarella_not_domain).
lemma(lnot(exists(v1,and(edamozzarella_topping(v1),exists(v2,has_topping(v2,v1))))),
	[and(forall(v1,implies(exists(v2,and(edam_topping(v2),has_topping(v1,v2))),lnot(exists(v2,and(mozzarella_topping(v2),has_topping(v1,v2)))))),
		forall(v1,implies(exists(v2,and(mozzarella_topping(v2),has_topping(v1,v2))),lnot(exists(v2,and(edam_topping(v2),has_topping(v1,v2)))))))],
	edamozzarella_not_range).
